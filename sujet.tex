...
Ci-dessous, un exemple de contenu pour les différentes tables de la base de données. 
      ...
      \begin{objectif}
        ...
        \item une page avec un formulaire pour ajouter un arrêt sur une ligne $n$ au rang $k$ à l'URL \url{http://localhost:8081/arret/ajout?noligne=n\&rang=k}.
        \end{itemize}
      ...
      \begin{objectif}
        Lors de la suppression d'un train, supprimer tous ses départs automatiquement. Lors de la suppression d'une ligne, de même supprimer tous ses arrêts et les départs sur cette ligne. 
      \end{objectif}
